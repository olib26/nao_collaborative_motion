...
// called once when the goal completes
	void doneCb(const actionlib::SimpleClientGoalState& state,
	            const nao_behavior_tree::ROSResultConstPtr& result);
// called once when the goal becomes active
	void activeCb();
// called every time feedback is received for the goal
	void feedbackCb(const nao_behavior_tree::ROSFeedbackConstPtr& feedback);
...
private:
	...
	bool finished_;
	bool received_;
	actionlib::SimpleActionClient<nao_behavior_tree::ROSAction> ac_;
